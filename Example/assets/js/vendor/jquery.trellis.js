...
/* ===============================  Initialize Headroom.js and customize class name =============================== */
...
function sizeNav() {
    if ($('.t-mobmenu').length == 0) {
        ...
        if (!$('#t-scrollnav-holder.unlock').length) {
            ...
            $('#t-scrollnav-holder').next().css('margin-top', 0);
        }
    }
...
function setMenuClick() {
    ...
    $(window).scroll(function() {
        ...
        if (!$('#t-scrollnav-holder.unlock').length) {
            ...
            $('#t-scrollnav-holder').css('transform', 'translateY(0px)');
        }
    });
